...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
      ...
      body: cartItems.isEmpty
          ...
          : Column(
              children: [
                ...
                Expanded(
                  child: _buildStepContent(cartItems, localizationService),
                ),
                Padding(
                  padding: const EdgeInsetsDirectional.symmetric(
                    horizontal: 16,
  ...
  Widget _buildReview(List<CartItem> items, LocalizationService localization) {
    ...
    final textDirection = localization.textDirection;
    final textAlign = textDirection == TextDirection.rtl
        ? TextAlign.right
        : TextAlign.left;
        ...
        children: [
          ...
          ...items.map(
            (item) => ListTile(
              ...
              subtitle: Text(
                '${item.quantity} × ${CurrencyUtils.format(item.price)}',
                textAlign: textAlign,
              ),
              trailing: Text(
          ...
          _ReviewRow(
            ...
            value: CurrencyUtils.format(deliveryFee),
            textDirection: textDirection,
          ),
          const Divider(),
          _ReviewRow(
